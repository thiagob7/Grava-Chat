...
export default function Permissions() {
  return (
    <article className="space-y-10">
      <header>
        <Trail group="Fundamentos" page="Permissões" />
        <Title call="O que um bot consegue fazer é o que os cargos dele permitem — a mesma conta que vale para gente vale para código.">
          Permissões
        </Title>
      </header>

      <Section id="como-somam" title="Como elas somam">
        <p>
      ...
      <Section id="lista" title="A lista">
        <PermissionsTable />
      </Section>

      <Ahead href="/desenvolvedores/permissoes" />
    </article>
  );
}
