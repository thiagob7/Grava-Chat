        ...
        <div data-gc="perfil.cartao.profile-card-visual.div--6" className="relative -mt-10 mb-3 flex items-start gap-3">
          {staff && (
            <Tooltip data-gc="perfil.cartao.profile-card-visual.tooltip" label={t("perfil.cartao.equipe")}>
              ...
              >
                <img data-gc="perfil.cartao.profile-card-visual.img" src="/brand/icone-512.png" alt="" className="size-4 object-contain" />
              </span>
            </Tooltip>
          )}
          ...
          */}
          ...
          <Avatar data-gc="perfil.cartao.profile-card-visual.avatar"
            ...
            className={cn(
              "rounded-full",
              !hasDecoration && (theme ? "ring-[6px] ring-transparent" : "ring-[6px] ring-surface-0"),
            )}
          />
          </button>
