...
export const DicaDoServidor: React.FC<DicaDoServidorProps> = ({ nome, verificada, detectavel, vozes, children }) => (
    ...
    <TooltipPrimitive.Portal>
      ...
      >
        <p data-gc="servidor.dica-do-servidor.p" className="flex items-center gap-1.5 text-sm font-semibold text-ink">
          <SeloDaComunidade data-gc="servidor.dica-do-servidor.selo-da-comunidade" verificada={verificada} detectavel={detectavel} semDica />
          <span data-gc="servidor.dica-do-servidor.span" className="truncate">{nome}</span>
        </p>
        ...
        {vozes.map((canal) => (
          <div data-gc="servidor.dica-do-servidor.div" key={canal.channelId} className="mt-2.5">
            <p data-gc="servidor.dica-do-servidor.p--2" className="flex items-center gap-1.5 text-xs text-ink-muted">
              ...
              <span data-gc="servidor.dica-do-servidor.span--2" className="truncate">{canal.channelName}</span>
            </p>
