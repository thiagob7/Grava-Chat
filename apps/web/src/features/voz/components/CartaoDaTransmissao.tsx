  ...
  return (
    ...
    >
      <span data-gc="voz.cartao-da-transmissao.span" className="relative flex size-7 shrink-0 items-center justify-center overflow-hidden rounded bg-surface-4">
        ...
        <span data-gc="voz.cartao-da-transmissao.span--2" className="absolute -bottom-px -right-px flex size-3.5 items-center justify-center rounded-sm bg-surface-3">
          <Videocam data-gc="voz.cartao-da-transmissao.videocam" />
        </span>
      </span>
...
const Videocam: React.FC = () => (
  <svg data-gc="voz.cartao-da-transmissao.svg" viewBox="0 0 16 16" className="size-2.5 fill-ink" aria-hidden>
    <path data-gc="voz.cartao-da-transmissao.path" d="M1.5 4h7A1.5 1.5 0 0 1 10 5.5v5A1.5 1.5 0 0 1 8.5 12h-7A1.5 1.5 0 0 1 0 10.5v-5A1.5 1.5 0 0 1 1.5 4Zm10.2 2.1 2.6-1.5a.5.5 0 0 1 .7.44v5.92a.5.5 0 0 1-.7.44l-2.6-1.5a.5.5 0 0 1-.25-.44V6.54a.5.5 0 0 1 .25-.44Z" />
  </svg>
);
