...
export const GRUPOS_DE_TOKENS: GrupoDeTokens[] = [
  {
    ...
    tokens: [
      ...
      },
      {
        nome: "--text-11",
        rotulo: "Tamanho 11px",
        dica: "rótulos e legendas",
        ligado: true,
      },
      {
        nome: "--text-12",
        rotulo: "Tamanho 12px",
        dica: "o apelido text-xs",
        ligado: true,
      },
      {
        nome: "--text-13",
      ...
      },
      {
        nome: "--text-14",
        rotulo: "Tamanho 14px",
        dica: "o tamanho dominante da interface; o apelido text-sm",
        ligado: true,
      },
      {
        nome: "--text-16",
        rotulo: "Tamanho 16px",
        dica: "o apelido text-base",
        ligado: true,
      },
      {
        nome: "--text-18",
        rotulo: "Tamanho 18px",
        dica: "o apelido text-lg",
        ligado: true,
      },
      {
        nome: "--text-20",
        rotulo: "Tamanho 20px",
        dica: "o apelido text-xl",
        ligado: true,
      },
      {
        nome: "--text-24",
        rotulo: "Tamanho 24px",
        dica: "o apelido text-2xl",
        ligado: true,
      },
      {
        nome: "--text-xs",
      ...
      {
        nome: "--font-weight-normal",
        rotulo: "Peso normal (400)",
        ligado: true,
      },
      {
        nome: "--font-weight-medium",
        rotulo: "Peso médio (500)",
        ligado: true,
      },
      {
      ...
      { nome: "--font-weight-bold", rotulo: "Peso grosso (700)", ligado: true },
