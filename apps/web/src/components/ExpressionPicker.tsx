...
/**
 * A aba de GIF virou `components/GradeDeGifs.tsx` quando o seletor da faixa de
 * perfil passou a precisar da mesma grade. Aqui ficou só o adaptador de busca.
 */
const AbaGifs: React.FC<{ busca: string; onGif: (gif: GifModel) => void }> = ({ busca, onGif }) => (
  <GradeDeGifs busca={busca} onGif={onGif} />
);
