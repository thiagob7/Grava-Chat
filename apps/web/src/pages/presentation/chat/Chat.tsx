  ...
  return (
    <div data-gc="chat.chat.div" className="flex h-full bg-surface-0">
      ...
      <div data-gc="chat.chat.div--2" className="topo-do-miolo flex min-w-0 flex-1 flex-col">
        {!semCabecalho && (
        <header data-gc="chat.chat.header" className="regiao-de-arrasto @container flex h-12 shrink-0 items-center gap-2 border-b border-divisor bg-cabecalho px-4 shadow-sm">
          {telaEstreita && (
